...
// `to` debe venir en formato E.164 con "+" (ej: +56912345678) — el prefijo
// "whatsapp:" se agrega acá. Nunca lanza: siempre devuelve { ok, reason }
// para que el flujo que llama (creación de cita, cron de recordatorios)
// jamás se rompa por un fallo de Twilio.
